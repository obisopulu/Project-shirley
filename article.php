...
$seo_title = "$knowledgebaseTopic - breedersng Knowledge Base";
...
$seo_img = "https://www.breeders.ng/knowledgebaseimg/$knowledgebasePicture";
$seo_url = "https://www.breeders.ng/article.php?id=$knowledgebaseID";
$seo_author = "breeders";
$seo_date = "$today";
...
$linkTitle = $postTitle;
$linkTitle = clean_input2($linkTitle);
$link = strtolower("article.php?id=".$knowledgebaseID);
}
?>
