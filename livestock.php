...
mysqli_query($cxn, "INSERT INTO anonymouser(anonymousID, anonymousIP, anonymousPage, anonymousPlatform, anonymousDevice, anonymousTime, dateUpdated) VALUES (NULL, '$userIP', 'Livestock', '$anonymousPlatform', '$anonymousDevice', '$current_time_day','$today')") or die("Home");



$seo_title = "Buy Livestock in Nigeria - breedersng";
$seo_description = "Buy Livestock ( Cow, Sheep, Goat, Pigs, Chiken, Turkey and more ) from Nigeria's online breeders Marketplace, or sell";
$seo_keywords = "buy, meat, chiken, cow, cattle, pork, pig, hen, fowl, poultry, turkey, sell, pet, livestock, feed, accessory, nigeria, farm, dog, cat,  goat, sheep, poultry, puppies, horse, cow, chiken, mice, money";
$seo_img = "img/banner.png";
$seo_url = "https://www.breeders.ng/livestock/";
$seo_author = "breeders";
$seo_date = "$today";
...
<div id="page_pic" class="page_pic_l"></div>
...
<?php $cat = "Livestock"; include("services/footer_head.php");?>
...
<div id="match_screen_width" class="livestock" align="center">
<table id="scroller_table"><tr>

<?php 
$sql_frame = mysqli_query($cxn, "SELECT DISTINCT postSubCategory FROM poster WHERE postCategory = 'Livestock' AND postSubCategory != '' ORDER BY RAND() LIMIT 10");
...
<div id="seo_description" class="livestock">
...
$sql_poster = mysqli_query($cxn, "SELECT * FROM poster WHERE postStatus = 'Live' AND postCategory = 'Livestock' ");
...
$sql_poster = mysqli_query($cxn, "SELECT * FROM poster WHERE postStatus = 'Live' AND postCategory = 'Livestock' ORDER BY postID DESC LIMIT $pageno, 20");
...
<div align="center">
<ul>
	<?php $x = $current_page - 1; if ($current_page > 1){ ?><li id="pagination_livestock" onClick="location = '<?php echo $_SERVER["PHP_SELF"]."?p='+$x"?>" 
	> |< </li><?php }else {echo "<li id='pagination_livestock' > .... </li>";}?>
	<select id="pagination_livestock" name="p" onchange="location = '<?php echo $_SERVER["PHP_SELF"]; ?>?p='+this.value;">
	<?php 
	...
	<?php if ($current_page < $count_page ){?><li id="pagination_livestock" <?php $current_page++;?>
